...
class LicensesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create license" do
    assert_difference("License.count") do
      post licenses_url, params: { license: { authorized: @license.authorized, checked: @license.checked, user_id: @license.user_id } }
    end
  ...
  test "should update license" do
    patch license_url(@license), params: { license: { authorized: @license.authorized, checked: @license.checked, user_id: @license.user_id } }
